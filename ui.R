  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput(inputId = "habitat.campaignid.selector", label = "CampaignID",
                  choices = NULL),
    selectInput("habitat.type", "Select habitat type for bubble plot", choices = c("Macroalgae","Stony corals","Octocoral black","Sponges","Hydroids","Consolidated","Unconsolidated"), multiple = FALSE),width = 3),
    # Plots
    mainPanel(
